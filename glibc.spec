...
VCS: https://src.suse.de/pool/glibc?trackingbranch=slfo-1.2#99d9e86c192b149c4cb73106357bc60105e589a495fabce1bf5e49fde994859d
...
mkdir -p %{buildroot}/usr/lib64;ln -s %{buildroot}/usr/lib64 %{buildroot}/usr/lib
# Install locales
%if %{build_locales}
	cd cc-base
...
* Mon Sep 30 2024 sbrabec@suse.com
- langpacks are no more used. Drop glibc-2.3.90-langpackdir.diff.
* Thu Sep 26 2024 schwab@suse.de
...
* Mon Jul 29 2024 schwab@suse.de
...
- bsc#1228041
* Mon Jun  3 2024 dimstar@opensuse.org
...
* Tue May 28 2024 schwab@suse.de
...
* Mon May 13 2024 schwab@suse.de
- glibc-CVE-2024-33599-nscd-Stack-based-buffer-overflow-in-n.patch:
...
- elf-parse-tunables.patch: elf: Only process multiple tunable once (BZ
  [#31686])
* Mon Apr 29 2024 giuliano.belinassi@suse.com
...
* Tue Feb 27 2024 lnussel@suse.com
